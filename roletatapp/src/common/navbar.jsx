                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown">
                                <a className="nav-link dropdown-toggle text-white" href="src/common/navbar#" role="button" data-bs-toggle="dropdown"
                                   aria-expanded="false">
                                    Types of Blind
                                </a>
                                <ul className="dropdown-menu bg-dark">
                                    ...
                                    <li>
                                        <Link to="/venetiane">
                                        <a className="dropdown-item text-white">Venetiane
                                        </a>
                                        </Link>
                                    </li>
                                </ul>
